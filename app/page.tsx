...
const differentiators = [
  ...
  "Built for engineers and career switchers who want execution, not a demo.",
      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto grid min-h-screen max-w-7xl items-center gap-12 px-6 pb-16 pt-28 sm:px-8 lg:grid-cols-[1.08fr_0.92fr] lg:px-10">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/8 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-cyan-200">
              <Sparkles className="h-3.5 w-3.5" />
              Private career workspace
            </div>

            <div className="space-y-5">
              <h1 className="max-w-3xl font-sinistre text-[clamp(3rem,8vw,5.25rem)] font-black leading-[0.95] tracking-[-0.06em] text-white">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-300 px-6 py-3 text-sm font-semibold text-black transition hover:bg-cyan-200"
              >
                Start onboarding
              ...
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/[0.07]"
              >
                Open dashboard
              </Link>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-white/10 bg-[#0a0a0c] p-5">
              ...
              <ol className="mt-4 space-y-4 text-sm leading-7 text-slate-300">
                <li className="flex gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-cyan-300/20 bg-cyan-300/10 text-xs font-semibold text-cyan-200">1</span>
                  You enter a private dashboard with your profile, readiness score, and saved roadmap state.
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-cyan-300/20 bg-cyan-300/10 text-xs font-semibold text-cyan-200">2</span>
                  You can review roadmaps, mentor prompts, and notes without re-entering context.
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-cyan-300/20 bg-cyan-300/10 text-xs font-semibold text-cyan-200">3</span>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20 sm:px-8 lg:px-10">
          <div className="grid gap-4 lg:grid-cols-2">
            <article className="rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-6">
              ...
              <h2 className="mt-4 font-sinistre text-3xl font-black tracking-[-0.04em] text-white">People who want a private operating system for career progress.</h2>
            ...
            <article className="rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-6">
              ...
              <h2 className="mt-4 font-sinistre text-3xl font-black tracking-[-0.04em] text-white">Less spectacle. More recall. More follow-through.</h2>

...
import { ResourceDiscoveryWorkspace } from "@/components/resource-discovery-workspace";
...
export default async function ResourceDiscoveryPage() {
  let profile = null;
  let workspace = null;
  ...
  return (
    <WorkspaceShell profile={profile} workspace={workspace}>
      <CommunitySupportProvider profile={profile} workspace={workspace}>
        <CommunitySupportLayout activeTab="discovery">
          <ResourceDiscoveryWorkspace />
